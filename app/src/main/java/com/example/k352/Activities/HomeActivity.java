...
import com.example.k352.Fragments.DisplayCategoryFragment;
import com.example.k352.Fragments.DisplayHomeFragment;
import com.example.k352.Fragments.DisplayStaffFragment;
import com.example.k352.Fragments.DisplayStatisticFragment;
import com.example.k352.Fragments.DisplayTableFragment;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tendn = intent.getStringExtra("manv");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.nav_home:
                //hiển thị tương ứng trên navigation tc
                FragmentTransaction tranDisplayHome = fragmentManager.beginTransaction();
                DisplayHomeFragment displayHomeFragment = new DisplayHomeFragment();
                tranDisplayHome.replace(R.id.contentView,displayHomeFragment);
                tranDisplayHome.commit();
            ...
            case R.id.nav_statistic:
                //hiển thị tương ứng trên navigation tk
            ...
            case R.id.nav_table:
                //hiển thị tương ứng trên navigation ba
            ...
            case R.id.nav_category:
                //hiển thị tương ứng trên navigation mn

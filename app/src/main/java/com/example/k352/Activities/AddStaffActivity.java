...
import com.example.k352.DAO.NhanVienDAO;
import com.example.k352.DTO.NhanVienDTO;
...
public class AddStaffActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private boolean validatePhone(){
        ...
        if(val.isEmpty()){
            ...
            TXTL_addstaff_SDT.setError("SAI rồi nka nhập lại điii!");
            return false;
        }
        else {
    ...
    private boolean validateAge(){
        ...
        if(isAgeValid < 15){
            Toast.makeText(this,"Bạn chưa đủ tuổi để tham gia!",Toast.LENGTH_SHORT).show();
            return false;
        }
        if(isAgeValid > 60){
            Toast.makeText(this,"Bạn đã quá tuổi để tham gia :( ",Toast.LENGTH_SHORT).show();
            return false;}
        else {
            return true;
        }

...
import static com.example.k352.R.id.btn_addcategory_TaoLoai;
...
private  void  re(){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTN_addcategory_TaoLoai = (Button)findViewById(btn_addcategory_TaoLoai);
